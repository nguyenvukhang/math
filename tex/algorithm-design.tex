...
\end{proof}
% \begin{itemize}
%   \item A polynomial-time verifier for $L$ would take an input $x$ and
%     a proposed certificate $y$ and can check if $y$ is valid by
%     running $L(y)$
% \end{itemize}

% Find the longest slice in an array that sums up to 10
%
% Decision problem:
% There is a window in the array whose sum adds up to 10 exactly
