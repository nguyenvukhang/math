...
Let $E:=\set{x\in\mathbb Q}{x<\sqrt3}$. Then $\sup E=\sqrt3$.
...
\begin{proof}
  ...
  \href{d0c9c52}{Density Theorem}, there exists $r\in\mathbb Q$ such that
  \begin{equation*}
    \sup E<r<\sqrt3\Tag{*}
  \end{equation*}

  Since $r\in\mathbb Q$ and $r<\sqrt3$, it follows that $r\in E$. But this and
...
$$
  E_\alpha:=\set{x\in\mathbb Q}{x<\alpha}\subseteq\mathbb Q
$$
