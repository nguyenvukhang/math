\section{Calculus}\label{cbe77ad}
...
\Result{1.1.2}{Basic trigonometric constants}\label{e1c170b}
...
\Remark{2.1.1}{Differentiation identities}\label{e0367fa}
...
\Remark{2.1.2}{Integration identities}\label{dbd3301}
\begin{center}
...
\Remark{2.1.3}{Chain rule}\label{d969d46}
...
\Definition{2.1.4}{Differentiability}\label{c62315d}
...
\Definition{2.1.5}{Directional derivative}\label{dbbf530}
...
\Remark{2.1.6}{Gradient}\label{dad2713}
...
\Remark{2.1.7}{Jacobian}\label{a2ceb99}
