...
task corresponding to $L$ is ``Given a string $x\in\binrep$, is $x\in
L$?"
...
\begin{proof}
	...
	Then, following the \hyperref[ee3be28]{defintion of $\P$}, we need
...
\Definition{3.6}{coNP}\label{a92ed96}
...
\Remark{3.6.1}{The complexity class $\NP\cap\coNP$}\label{e6ea03d}
