...
% bundle located at `./prelude.sty`. Includes:
% [comment] for hiding proofs when studying for tests (DEPRECATED)
% [enumitem] for adding super powers to lists {itemize,enumerate}
\usepackage{tex_packages/prelude}
