  ...
  return (
    <div
      ...
      className={clsx(
        ...
        'text-fg1 bg-bg1 border border-bg0',
    ...
    >
      <div className="px-2 py-1.5 whitespace-nowrap">{children}</div>
      {position === 'right' && (
        <div
          className={clsx(
            ...
            'before:border-b before:border-l before:border-solid before:border-bg0',
            'after:border-b after:border-l after:border-solid after:border-bg0',
      ...
      {position === 'bottom' && (
        <div
          className={clsx(
            ...
            "before:absolute before:w-[6px] before:h-[6px] before:bg-inherit before:visible before:rotate-45 before:content-['']",
            "after:absolute after:w-[7px] after:h-[7px] after:bg-inherit after:visible after:rotate-45 after:content-['']",
            'before:border-t before:border-l before:border-solid before:border-bg0',
            'after:border-t after:border-l after:border-solid after:border-bg0',
            'after:invisible before:invisible group-hover:after:visible group-hover:before:visible',
            {
