...
\Definition{1.1.1}{Supremum/Infimum}
...
\Definition{1.1.2}{Subsequential limit}
...
\Definition{1.1.3}{Limit superior/limit inferior}
...
\begin{align*}
	\lim\sup x_n & := \lim_{n\to\infty}\sup\Set{x_k}{k\geq n} \\
	\lim\inf x_n & := \lim_{n\to\infty}\inf\Set{x_k}{k\geq n}
\end{align*}
