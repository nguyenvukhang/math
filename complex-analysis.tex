...
\Definition{2.6.2}{Integrating over a piecewise $C^1$ curve}
...
where $a_1,a_2,\ldots,a_k$ are as in \hyperref[baf22ac]{Definition
	2.6.1}.
...
(This is really just \hyperref[c526c09]{Proposition 2.1.6} restated
...
\Theorem{2.6.7}{Cauchy integral formula and theorem: general form}
...
\Theorem{3.1.1}{Analyticity of holomorphic functions}
...
\Corollary{3.1.2}{Derivative of a holomorphic function is holomorphic}
...
\Theorem{3.1.4}{Morera's Theorem}
