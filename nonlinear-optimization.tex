...
% #[comment]
% If F is cont. diff and F'(x̄) is invertible, then F' is invertible in
% a neighborhood. Moreover, the norm of inverse F' is bounded in that
% neighborhood.
