...
\begin{enumerata}
	...
	\hyperref[dcb7f73]{affine} function $g:\R^n\to\R$ which minorizes
	$f$ everywhere, i.e.
	$$
...
\begin{proof}
  ...
  \hyperref[dc165c9]{Fermat's Theorem}. (iii) $\implies$ (i) follows
  from \hyperref[cd9cea7]{Theorem 2.2.1 a)}.
\end{proof}
...
\begin{proof}
	...
	Passing to the limit on $K$ and using \hyperref[f8e1f12]{Lemma
		3.2.3} gives
	$$
...
\Theorem{3.3.9}{Global convergence of \hyperref[a7a5665]{Algorithm 3.3.3}}\label{a66db73}
...
\Theorem{5.1.13}{\hyperref[b38093d]{KKT} under \hyperref[adc266e]{ACQ}}\label{b1c5437}
